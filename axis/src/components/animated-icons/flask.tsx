...
const FlaskIcon = forwardRef<FlaskIconHandle, HTMLAttributes<HTMLDivElement>>(
	(props, ref) => {
		...
		// Start the infinite animation automatically on mount
		useEffect(() => {
		...
		return (
			...
			>
				...
				>
					...
					<motion.path
						d="M456.145,436.364l-79.127-124.509c0-2.327-2.327-4.655-3.491-5.818l-34.909-55.855c-8.146-13.964-12.8-29.091-12.8-44.218
          ...
          c15.127,5.818,32.582,8.145,50.036,8.145c22.109,0,43.055-4.655,60.509-12.8
          c25.6-12.8,68.655-13.964,96.582-1.164l79.127,125.673c3.491,5.818,5.818,11.636,5.818,18.618V477.091z"
						variants={{
