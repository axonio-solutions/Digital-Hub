...
interface SellerMarketplaceScreenProps {
  user: SessionUser
...
export function SellerMarketplaceScreen({
  user,
  onNavigateBilling,
  onSelectRequest,
  refreshKey,
}: SellerMarketplaceScreenProps) {
  const t = useTheme()
  ...
  const load = useCallback(
    async (isRefresh?: boolean) => {
      ...
      try {
        const [requestsData, taxonomy, credit] = await Promise.all([
          fetchOpenRequests(buildFilters(0)),
          getPublicTaxonomyFn(),
          fetchCreditBalance(),
        ])
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyDesc, { color: t.textMuted }]}>
                {search || activeFilterCount > 0
                  ...
                  : 'No one has posted a request yet.'}
              </Text>
            </View>
          ) : null
        }
        ...
        >
          ...
          >
            ...
            <Text style={[styles.modalDesc, { color: t.textMuted }]}>
              You need at least 1 credit to submit a quote. Request more credits
              to continue.
            </Text>
    ...
    >
      ...
      >
        <View style={styles.cardImageWrap}>
            ...
            <View style={styles.cardBadgesRight}>
              {item.isPriority && (
                <View style={styles.urgencyBadge}>
                  <Text style={styles.urgencyBadgeText}>ASAP</Text>
                </View>
              )}
              {item.category && (
                <View
          ...
          <View
            style={[styles.blurCornerTR, { backgroundColor: t.primary + '08' }]}
          />
          <View
            style={[styles.blurCornerBL, { backgroundColor: '#3b82f6' + '08' }]}
          />
        </View>
