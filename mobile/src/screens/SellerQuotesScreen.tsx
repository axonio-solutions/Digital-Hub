...
interface SellerQuotesScreenProps {
  user: SessionUser
  refreshKey: number
  onEditQuote: (
...
const SORT_OPTIONS: Array<{
  ...
  { key: 'date-new', icon: 'arrow-down', label: 'Newest' },
  { key: 'date-old', icon: 'arrow-up', label: 'Oldest' },
  { key: 'price-asc', icon: 'trending-up', label: 'Low Price' },
  { key: 'price-desc', icon: 'trending-down', label: 'High Price' },
]
        ...
        >
          ...
          <View style={styles.qCardBody}>
            <View style={styles.qCardTopRow}>
              ...
              >
                <View
                  style={[styles.qCardStatusDot, { backgroundColor: meta.dot }]}
                />
              ...
              <View style={styles.qCardTimeRow}>
                <Ionicons name="time-outline" size={11} color={t.textSubtle} />
            ...
            >
              ...
              <View style={styles.qCardVehicleInfo}>
                ...
                <Text style={[styles.qCardVehicleYear, { color: t.textMuted }]}>
                  {item.request.modelYear} &middot;{' '}
                  {item.condition === 'new' ? 'New part' : 'Used part'}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.qCardPriceRow}>
              ...
              >
                <Ionicons
                  name={
                    item.condition === 'new' ? 'cube-outline' : 'reload-outline'
                  }
                  size={10}
                  color={t.accent}
                />
...
export function SellerQuotesScreen({
  user,
  refreshKey,
  onEditQuote,
  ...
  const load = useCallback(
    async (isRefresh?: boolean) => {
      ...
      try {
        const data = await fetchSellerQuotes()
        setQuotes(data)
      } catch {
        // silently fail
      } finally {
  ...
  async function confirmRetract() {
    ...
    try {
      ...
      setErrorMessage(err?.message || 'Failed to remove offer.')
      setShowError(true)
    } finally {
  ...
  async function handleRemind(quoteId: string) {
    ...
    try {
      ...
      setErrorMessage(err?.message || 'Failed to send reminder.')
      setShowError(true)
    } finally {
      setActionLoading(null)
    }
  ...
  return (
    <View style={[styles.root, { backgroundColor: t.bg }]}>
        ...
        <View style={styles.stickyHeaderInner}>
          <View style={styles.titleRow}>
            ...
            <View style={styles.headerTextWrap}>
              <Text style={[styles.title, { color: t.text }]}>My Quotes</Text>
              <Text style={[styles.titleSub, { color: t.textMuted }]}>
                {quotes.length} total
                {quotes.length > 0 ? ` · ${pendingQuotes.length} active` : ''}
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <TextInput
              ...
              placeholder="Search quotes, parts..."
          ...
          !loading ? (
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptyDesc, { color: t.textMuted }]}>
                {tab === 'all'
                  ? 'Browse the marketplace and submit offers on requests.'
                  : tab === 'won'
                    ? 'Accepted quotes will appear here once buyers approve your offers.'
                    : tab === 'lost'
                      ? 'Rejected quotes show up here.'
                      : 'Try adjusting your filters.'}
              </Text>
            </View>
          ) : null
        }
        ListHeaderComponentStyle={loading ? undefined : { display: 'none' }}
      ...
      >
        ...
        />
        {activeFilterCount() > 0 && (
          <View style={[styles.fabBadge, { backgroundColor: t.accentFg }]}>
        ...
        <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
          ...
          >
            ...
            <Text style={[styles.wcDesc, { color: t.textMuted }]}>
              Remove this offer from the marketplace?
            </Text>
            <View style={styles.wcActions}>
              ...
              >
                ...
                <Text style={styles.wcConfirmText}>Remove</Text>
              </Pressable>
            </View>
          </Animated.View>
        </View>
      ...
      {showError && (
        <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
          ...
          >
            ...
            <Text style={[styles.wcTitle, { color: t.text }]}>Error</Text>
            <Text style={[styles.wcDesc, { color: t.textMuted }]}>
              {errorMessage}
            </Text>
            <Pressable
            ...
            >
              <Text style={styles.wcConfirmText}>OK</Text>
            </Pressable>
          </View>
        </View>
      )}
        ...
        <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
          ...
          >
            ...
            <Text style={[styles.wsDesc, { color: t.textMuted }]}>
              Your offer has been removed successfully.
            </Text>
            <Pressable
            ...
            >
              <Ionicons name="checkmark-outline" size={18} color="#fff" />
              <Text style={styles.wsBtnText}>Done</Text>
            </Pressable>
          </Animated.View>
        </View>
      )}
