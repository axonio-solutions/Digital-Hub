...
function CreditRequestsRoute() {
  ...
  const columns = useCreditRequestsColumns(
    approve,
    reject,
    isApproving,
    isRejecting,
  ...
  const statusLabel = (status: string) => {
    switch (status) {
      case 'pending':
        return t('credit_requests.filter_pending')
      case 'approved':
        return t('credit_requests.filter_approved')
      case 'rejected':
        return t('credit_requests.filter_rejected')
      default:
