    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="space-y-3">
          <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60">Supported Vehicle Brands</Label>
        ...
        <div className="space-y-3">
          <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60">Part Categories</Label>
          <div className="flex flex-wrap gap-2">
