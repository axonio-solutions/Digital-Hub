          ...
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base text-muted-foreground max-w-md mx-auto leading-relaxed">
                Thank you for joining <span className="text-primary font-bold">MLILA</span>. Your store profile is currently in our <span className="font-semibold text-foreground">moderation queue</span>.
              </p>
            </div>
