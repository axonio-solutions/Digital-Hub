    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-muted-foreground font-medium">
          {t('notifications_section.loading')}
        </p>
      </div>
    )
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <Card className="border shadow-sm bg-card rounded-xl overflow-hidden">
        <CardHeader className="pb-4">
          ...
          <CardDescription>
            {t('notifications_section.delivery_desc')}
          </CardDescription>
        </CardHeader>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <Label className="text-sm font-semibold">
                  {t('notifications_section.in_app')}
                </Label>
                <p className="text-xs text-muted-foreground">
                  {t('notifications_section.in_app_desc')}
                </p>
              </div>
            </div>
            <Switch
            ...
            <div className="flex items-center gap-4 opacity-60">
              ...
              <div>
                <Label className="text-sm font-semibold flex items-center gap-2">
                  ...
                  <span className="text-[10px] bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400 px-1.5 py-0.5 rounded-full font-bold uppercase tracking-wider">
                    {t('notifications_section.coming_soon')}
                  </span>
                </Label>
                <p className="text-xs text-muted-foreground">
                  {t('notifications_section.email_desc')}
                </p>
              </div>
            </div>
            <Switch
      ...
      {role === 'seller' && (
        <Card className="border shadow-sm bg-card rounded-xl overflow-hidden">
          <CardHeader className="border-b bg-muted/20 pb-6">
            ...
            <CardDescription>
              {t('notifications_section.seller_strategy_desc')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-8 pt-8">
            <div className="space-y-4">
              <div>
                <Label className="text-xs font-semibold text-primary mb-1 block">
                  {t('notifications_section.frequency')}
                </Label>
                <p className="text-xs text-muted-foreground">
                  {t('notifications_section.frequency_desc')}
                </p>
              </div>
              <RadioGroup
                value={settings?.sellerAlertFrequency}
                onValueChange={(val) =>
                  handleUpdate({ sellerAlertFrequency: val })
                }
              ...
              >
                <div className="relative">
                  ...
                  <Label
                    htmlFor="freq-imm"
                    className="flex flex-col p-4 rounded-xl border cursor-pointer border-transparent bg-muted/30 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5 transition-all hover:bg-muted/50"
                  >
                    <span className="font-semibold mb-1">
                      {t('notifications_section.immediate')}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium leading-relaxed">
                      {t('notifications_section.immediate_desc')}
                    </span>
                  </Label>
                </div>
                <div className="relative">
                  ...
                  >
                    <span className="font-semibold mb-1">
                      {t('notifications_section.daily_digest')}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium leading-relaxed">
                      {t('notifications_section.daily_digest_desc')}
                    </span>
                  </Label>
                </div>
              </RadioGroup>
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-xs font-semibold text-primary mb-1 block">
                  {t('notifications_section.visibility')}
                </Label>
                <p className="text-xs text-muted-foreground font-medium">
                  {t('notifications_section.visibility_desc')}
                </p>
              </div>
              <RadioGroup
                ...
                <div className="relative">
                  ...
                  >
                    <span className="font-semibold mb-1 flex items-center gap-2">
                      ...
                      {t('notifications_section.my_specialties')}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium leading-relaxed">
                      {t('notifications_section.my_specialties_desc')}
                    </span>
                  </Label>
                </div>
                <div className="relative">
                  ...
                  >
                    <span className="font-semibold mb-1 flex items-center gap-2">
                      ...
                      {t('notifications_section.global_access')}
                    </span>
                    <span className="text-[10px] text-muted-foreground font-medium leading-relaxed">
                      {t('notifications_section.global_access_desc')}
                    </span>
                  </Label>
                </div>
              </RadioGroup>
      ...
      {role === 'admin' && (
        <Card className="border-red-200 shadow-sm bg-red-50/10 rounded-xl overflow-hidden">
          <CardHeader>
            ...
            <CardDescription>
              {t('notifications_section.admin_sim_desc')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-xl border border-red-500/20 bg-muted/30">
              <div>
                <p className="text-sm font-semibold text-red-900 dark:text-red-400">
                  {t('notifications_section.spam_test')}
                </p>
                <p className="text-xs text-muted-foreground">
                  {t('notifications_section.spam_test_desc')}
                </p>
              </div>
              <Button
                variant="destructive"
