...
import { Loader2, Upload, MapPin, User as UserIcon } from "lucide-react"
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <Card className="border-primary/5 shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>Update your avatar and personal contact details.</CardDescription>
                    </CardHeader>
                        ...
                        <div className="flex items-center gap-6 pb-2">
                            <Avatar className="h-20 w-20 border-2 border-primary/10 shadow-sm">
                                ...
                                <AvatarFallback className="bg-primary/5 text-primary text-xl font-black">
                                    {user?.name?.substring(0, 2).toUpperCase() || "AX"}
                                </AvatarFallback>
                            </Avatar>
                ...
                <Card className="border-primary/5 shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>Managed your primary location for deliveries and service.</CardDescription>
                    </CardHeader>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                <SelectItem value="Adrar">01 - Adrar</SelectItem>
                                                <SelectItem value="Chlef">02 - Chlef</SelectItem>
                                                <SelectItem value="Algiers">16 - Algiers</SelectItem>
                                                <SelectItem value="Oran">31 - Oran</SelectItem>
                                                <SelectItem value="Setif">19 - Sétif</SelectItem>
                                                <SelectItem value="Blida">09 - Blida</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormMessage />
                                    </FormItem>
