          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              {search.category && (
                <Button
                  variant="ghost"
                  className="h-4 p-0 text-[10px] font-bold text-primary hover:bg-transparent"
            ...
            <div className="flex items-center justify-between">
              ...
              {search.brands && search.brands.length > 0 && (
                <Button
                  ...
                  className="h-4 p-0 text-[10px] font-bold text-primary hover:bg-transparent"
                  onClick={() =>
                    navigate({ search: (p) => ({ ...p, brands: undefined }) })
                  }
                >
                  Clear
                </Button>
