...
export function AppSidebar({
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="group-data-[collapsible=icon]:!w-20 border-e-0 shadow-xl"
      {...props}
    >
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              <Link
                to="/dashboard"
                className="flex items-center gap-3 transition-all duration-300 group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:justify-center"
              >
