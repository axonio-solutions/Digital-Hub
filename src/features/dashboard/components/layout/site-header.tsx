          ...
          <NotificationDropdown
            ...
            trigger={
              <button className="relative size-10 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all group flex items-center justify-center">
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 size-5 bg-primary text-[10px] font-bold text-white rounded-full flex items-center justify-center border-2 border-white dark:border-slate-900 shadow-sm animate-in fade-in zoom-in duration-300">
                    {unreadCount}
                  </span>
                )}
              </button>
