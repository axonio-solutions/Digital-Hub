  ...
  const handleAction = (action: { type: string, item: any }) => {
    ...
    switch (action.type) {
      ...
      case 'update':
        ...
        break
      case 'delete':
        if (confirm('Permanently withdraw this proposal? This action cannot be undone.')) {
    ...
    return (
      <div className="flex h-[400px] items-center justify-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-muted-foreground">Loading sales pipeline...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your quotes and track your part sales.
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">DZD (Pending)</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
