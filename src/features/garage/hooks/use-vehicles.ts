...
import { getVehiclesServerFn, addVehicleServerFn, removeVehicleServerFn } from "@/fn/vehicles";
...
export function useAddVehicle() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({ queryKey: vehicleKeys.user(variables.userId) });
    },
  });
}
